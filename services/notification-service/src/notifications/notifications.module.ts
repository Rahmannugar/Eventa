...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      inject: [EMAIL_CLIENT, RUNTIME_CONFIG],
      useFactory: (emailClient: EmailClient, config: RuntimeConfig) =>
        new EmailVerificationEmailSender(emailClient, config.resendFrom),
    },
